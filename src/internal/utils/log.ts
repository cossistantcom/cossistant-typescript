...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: Cossistant): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: Cossistant): Logger {
